...
It then serves three ints (x, y and z), over and over again. To interface with it, you must use a client application that receives these three ints appropriately.
